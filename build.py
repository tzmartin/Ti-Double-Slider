...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.semanticpress.tidoubleslider.js')
	...
	f = os.path.join(cwd,'Classes','ComSemanticpressTidoublesliderModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.semanticpress.tidoubleslider.js']
